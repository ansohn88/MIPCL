...
def main(fold_num: int):
    """
    C17-420-6DQ_13 x 0.5 um_aoi7

    C17-6493-1DQ_13 x 0.5 um_aoi7  # model is correct; ask dan miller

    C17-9412-1DQ_13 x 0.5 um_aoi2  # GI contamination

    C17-10629-1DQ_13 x 0.5 um_aoi7  # model is correct
    """
    tiles_dir = "/home/andy/baraslab/projects/panc_cyto/Data/tiles_256/level_7"
    out_dir = "/home/andy/baraslab/projects/panc_cyto/mipcl_lit/visualizations/tiles"
    results_fp = "/home/andy/baraslab/projects/panc_cyto/mipcl_lit/results/fg_fc_dim384_thr0.85_temp0.07_aNone_bwNone/convnext_bagwt_None.pkl"

    viz = Visualization(
        tiles_dir=tiles_dir,
        top_tiles_outdir=out_dir,
    ...
    viz.get_top_tiles(save_tiles=True,
                      fold_num=fold_num,
                      id_only=False)

    # get ids only

    # return viz.get_top_tiles(save_tiles=False,
    #                          use_metric=False,
    #                          fold_num=7,
    #                          id_only=True)
...
if __name__ == '__main__':
    ...
    Parallel(n_jobs=10)(delayed(main)(i) for i in fold_nums)


# if __name__ == '__main__':
#     tiles_dir = "/home/andy/baraslab/projects/panc_cyto/Data/tiles_256/level_7"
#     out_dir = "/home/andy/baraslab/projects/panc_cyto/wsol_lit/visualizations/tiles"
#     results_fp = "/home/andy/baraslab/projects/panc_cyto/wsol_lit/results/prev_fgbg_dim384_thr0.65_temp0.07_aNone_bwNone/convnext_bagwt_None.pkl"
...
#         metric='f1_score'
#     )
#     # fname = 'C17-420-6DQ_13 x 0.5 um_aoi7_bag_features.h5'  # fold 2
#     fname = 'C17-2710-1DQ_13 x 0.5 um_JH_5244_aoi5_bag_features.h5'  # fold 6

#     viz.get_top_tiles_single_case(
#         fname, save_tiles=True, fold_num=6, id_only=False)
